...
module "app_service" {
  ...
  trsl_name          = module.azure_translater_service.trsl_name
  trsl_key           = module.azure_translater_service.trsl_key
}
...
resource "azurerm_load_test" "load_test" {
  # リソース名を lt-availability-dev とする。
  name                = "lt-availability-dev"
...
resource "azurerm_application_insights" "app_insights" {
  # リソース名を ai-availability-dev とする。
  name                = "ai-availability-dev"
  location            = azurerm_resource_group.rg.location
  resource_group_name = azurerm_resource_group.rg.name
